public class Constmult{
  Quantum q;
  PLU p;
  int n;
  
  public Constmult(int[] f, int[] m, Quantum c){
    p = new PLU(f, m);
    q = c;
    p.PLUdecomposition();
    n = p.P.length;
  ...
  public void mult(int g, byte[] d){ //applies constant multiplication to g..g+n-1 (n is fixed by m)
  ...
  public void multreverse(int g, byte[] d){ //the above but in reverse
    int[] P = new int[n];
